...
# Handles distro expansion for distro=any.
#
# Arguments:
#   package_file - Path to the .deb package file (e.g., "packages/cockpit-apt_1.0.0-1_all.deb")
...
#   route_package "packages/cockpit-apt_1.0.0-1_all.deb" "stable"
#
